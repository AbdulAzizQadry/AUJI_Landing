...
const Register = () => {
  ...
  const sendCode = async () => {
    ...
    const res = await fetch("https://auji-backend-production.up.railway.app/send-code", {
      method: "POST",
  ...
  const verifyCode = async () => {
    setMessage("");
    const res = await fetch("https://auji-backend-production.up.railway.app/verify-code", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch("https://auji-backend-production.up.railway.app/register", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
